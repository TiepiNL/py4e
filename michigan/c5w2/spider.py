'''
Spider script to crawl urls and store results in a sqlite database.
'''
import sqlite3
import ssl
...
if row is not None:
    ...
    if len(starturl) < 1:
        starturl = 'https://www.jacobsmeubels.nl/' #'http://python-data.dr-chuck.net/' #'http://www.dr-chuck.com/'
