...
def areatriangle(b,h):
    ...
    a = 0.5 * b * h
    print("The area of a triangle of base", b, "and height", h, "is", a)
...
def absolutevalue(num):
    """
    Multiply by -1 to make it greater than zero, if a number is
    less than zero.
    """
    if num < 0:
        abs_val = -num
        ...
        abs_val = num
    print("The absolute value of {} is {}".format(num, abs_val))
...
def inches_to_feet2(inches):
    """ converts inches to feet and inches """
    feet = inches // 12  # division by integer with fraction thrown away
    extra_inches = inches % 12 # remaining inches
    print(inches,"inches is",feet,"feet and",extra_inches,"inches") 
...
"""
#%%
def count_down(countdown=10):
    """ Count down from 10 to rocket launch """
    while countdown > 0:
        print(countdown, end=" ")
        countdown -= 1
    print("BLASTOFF!")
